...
To install Pulse-Adjoint, run this command in your terminal:

.. code-block:: console

    $ pip install pulse_adjoint

This is the preferred method to install Pulse-Adjoint, as it will always install the most recent stable release.
...
The sources for Pulse-Adjoint can be downloaded from the `Github repo`_.

You can either clone the public repository:

.. code-block:: console

    $ git clone git@github.com:finsberg/pulse_adjoint.git

Or download the `tarball`_:

.. code-block:: console

    $ curl -OJL https://github.com/finsberg/pulse_adjoint/tarball/master
...
.. _Github repo: https://github.com/finsberg/pulse_adjoint
.. _tarball: https://github.com/finsberg/pulse_adjoint/tarball/master
