#!/usr/bin/env python
#
# pulse_adjoint documentation build configuration file, created by
...
intersphinx_mapping = {
    ...
    "pulse": ("https://computationalphysiology.github.io/pulse/html/index.html", None),
}
...
htmlhelp_basename = "pulse_adjointdoc"
...
man_pages = [(master_doc, "pulse_adjoint", "Pulse-Adjoint Documentation", [author], 1)]
